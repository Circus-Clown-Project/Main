...
public class StackController {
    ...
    public StackController(int screenWidth, int screenHeight, GameObject clown, int movingSize, AudioController audio) {
        this.audio = audio;
    ...
    public void refresh(GameObject o) {
    ...
    private boolean intersectStacks(GameObject o1, GameObject o2) {
        return (o1.getHeight() + o1.getY() < o2.getY() + o2.getHeight() / 4 && o1.getHeight() + o1.getY() > o2.getY() && o1.getX() + o1.getWidth() / 2 <= o2.getX() + (o2.getWidth() * 7) / 8 && o1.getX() + o1.getWidth() / 2 >= o2.getX() + o2.getWidth() / 8);
    }
    ...
    public String handleGift() {
        ...
        while (entries.hasNext()) {
            ...
            for (int i = 0; i < entry.getValue().size(); i++) {
                ...
                if (object.getId() == 300 || object.getId() == 400) {
                    audio.playPointEarned();
                    entry.getValue().get(i).setY(-1 * (int) (Math.random() * screenHeight));
                    entry.getValue().get(i).setX((int) (Math.random() * screenWidth));
                    entry.getValue().pop();
                    if (object.getId() == 300) {
                        return "gift";
                    } else {
    ...
    public String handleBomb() {
        ...
        while (entries.hasNext()) {
            ...
            for (int i = 0; i < entry.getValue().size(); i++) {
                Shapes object = (Shapes) entry.getValue().get(i);
                if (object.getId() == 100 || object.getId() == 200) {
                    audio.playBomb();
